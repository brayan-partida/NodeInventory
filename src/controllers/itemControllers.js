...
controller.add = async (req, res) => {
    ...
    const query = await pool.query(item.insert(nameItem, descriptionItem, typeItem, codeItem, EncargadoItem));
...
controller.update = async (req, res) => {
    ...
    const query = await pool.query(item.update(nameItem, descriptionItem, typeItem, idItem, codeItem));
